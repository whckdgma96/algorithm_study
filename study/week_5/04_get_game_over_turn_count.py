    ...
    while turn_count <= 1000:
        ...
        for horse_index in range(horse_count):
            ...
            for i in range(len(cur_stacked_horse_map[r][c])):
                cur_stacked_horse_index = cur_stacked_horse_map[r][c][i]
                if horse_index == cur_stacked_horse_index:
                    moving_horse_index_array = cur_stacked_horse_map[r][c][i:]
            ...
            for moving_horse_index in moving_horse_index_array:
                cur_stacked_horse_map[new_r][new_c].append(moving_horse_index)
